(() => {
  ...
  R = {
    ...(r = R),
    get: (e, t, a) => (F(e, t) ? L : r.get(e, t, a)),
    has: (e, t) => F(e, t) || r.has(e, t),
  };
  ...
  class $ {
    ...
    async cachePut(e, t) {
      ...
      let { cacheName: i, matchOptions: c } = this._strategy,
        ...
        h = l ? await d(o, s.clone(), ["__WB_REVISION__"], c) : null;
      try {
  ...
  class X {
    ...
    async getAllEntriesByQueueName(e) {
      ...
      return (await t.getAllFromIndex(z, J, IDBKeyRange.only(e))) || [];
    }
    async getEntryCountByQueueName(e) {
      return (await this.getDb()).countFromIndex(z, J, IDBKeyRange.only(e));
    }
    async deleteEntry(e) {
      let t = await this.getDb();
      await t.delete(z, e);
    ...
    async getEndEntryFromIndex(e, t) {
      let a = await this.getDb(),
        s = await a.transaction(z).store.index(J).openCursor(e, t);
      return s?.value;
    }
    async getDb() {
      return (
  ...
  class Y {
    ...
    _queueDb;
    constructor(e) {
      ((this._queueName = e), (this._queueDb = new X()));
    }
    async pushEntry(e) {
      (delete e.id,
  ...
  class ee {
    ...
    clone() {
      return new ee(this.toObject());
    }
  }
  let et = "serwist-background-sync",
    ea = new Set(),
    es = (e) => {
      let t = {
        request: new ee(e.requestData).toRequest(),
  ...
  class er {
    ...
    constructor(
      ...
      if (ea.has(e)) throw new n("duplicate-queue-name", { name: e });
      (ea.add(e),
        (this._name = e),
    ...
    async _addRequest(
      ...
      let r = {
        requestData: (await ee.fromRequest(e.clone())).toObject(),
        timestamp: a,
      };
    ...
    async _removeRequest(e) {
      ...
      if (t) {
        ...
        return a - t.timestamp > s ? this._removeRequest(e) : es(t);
      }
    }
    ...
    async registerSync() {
      if ("sync" in self.registration && !this._forceSyncFallback)
        try {
          await self.registration.sync.register(`${et}:${this._name}`);
        } catch (e) {}
    }
    _addSyncListener() {
      "sync" in self.registration && !this._forceSyncFallback
        ? self.addEventListener("sync", (e) => {
            if (e.tag === `${et}:${this._name}`) {
              let t = async () => {
                let t;
    ...
    _useDefaultCacheabilityPluginIfNeeded() {
      ...
      for (let [a, s] of this.plugins.entries())
        s !== ec.copyRedirectedCacheableResponsesPlugin &&
          (s === ec.defaultPrecacheCacheabilityPlugin && (e = a),
          s.cacheWillUpdate && t++);
      0 === t
  ...
  let eu = "www.google-analytics.com",
    ed = "www.googletagmanager.com",
    em = /^\/(\w+\/)?collect/,
    ef = ({ serwist: e, cacheName: t, ...a }) => {
      let s,
        r,
        n = t || c(i.googleAnalytics),
        o = new en("serwist-google-analytics", {
      ...
      for (let t of [
        new O(
          ({ url: e }) => e.hostname === ed && "/gtm.js" === e.pathname,
          new Q({ cacheName: n }),
          "GET",
        ),
        new O(
          ({ url: e }) => e.hostname === eu && "/analytics.js" === e.pathname,
          new Q({ cacheName: n }),
          "GET",
        ),
        new O(
          ({ url: e }) => e.hostname === ed && "/gtag/js" === e.pathname,
          new Q({ cacheName: n }),
          "GET",
        ),
        new O(
          (s = ({ url: e }) => e.hostname === eu && em.test(e.pathname)),
          (r = new V({ plugins: [o] })),
          "GET",
        ),
        new O(s, r, "POST"),
  ...
  class ep {
    ...
    constructor({
      ...
      const {
        ...
        return {
          precacheStrategyOptions: {
            cacheName: o(a),
            plugins: [...s, new ew({ precacheController: e })],
            fetchOptions: r,
            matchOptions: n,
            fallbackToNetwork: i,
          },
      ...
      if (
        ...
        (this._precacheStrategy = new ec(g)),
        ...
        y.cleanupOutdatedCaches &&
          ((f = g.cacheName),
          self.addEventListener("activate", (e) => {
            e.waitUntil(p(o(f)).then((e) => {}));
          })),
        this.registerRoute(new eh(this, w)),
        y.navigateFallback &&
          this.registerRoute(
            new B(this.createHandlerBoundToUrl(y.navigateFallback), {
        ...
        if (void 0 !== d) {
          const e = new eg({ fallbackUrls: d.entries, serwist: this });
          l.forEach((t) => {
            t.handler instanceof H &&
...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`);
    ...
    registerCapture(e, t, a) {
      let s = ((e, t, a) => {
        ...
        if (e instanceof RegExp) return new K(e, t, a);
  ...
  class ex {
    ...
    _getId(e) {
      return `${this._cacheName}|${e_(e)}`;
    }
    _upgradeDb(e) {
      let t = e.createObjectStore(ey, { keyPath: "id" });
    ...
    async setTimestamp(e, t) {
      ...
      let a = {
        ...
        s = (await this.getDb()).transaction(ey, "readwrite", {
          durability: "relaxed",
        });
    ...
    async getTimestamp(e) {
      let t = await this.getDb(),
        a = await t.get(ey, this._getId(e));
      return a?.timestamp;
    }
    async expireEntries(e, t) {
      let a = await this.getDb(),
        s = await a
          .transaction(ey, "readwrite")
    ...
    constructor(e = {}) {
      ...
      ((this._config = e),
        ...
        this._config.purgeOnQuotaError &&
          ((t = () => this.deleteCacheAndMetadata()), m.add(t)));
    }
    _getCacheExpiration(e) {
      if (e === l()) throw new n("expire-custom-caches-only");
  ...
  new ep({
    precacheEntries: [
      {
        revision: null,
        url: "/_next/static/chunks/05c41a78-96e37b31196f10ea.js",
      },
      { revision: null, url: "/_next/static/chunks/315-5b9422c1c9bee32f.js" },
      {
        revision: null,
        url: "/_next/static/chunks/567ea526-282e8eaaa003b2fd.js",
      },
      { revision: null, url: "/_next/static/chunks/594-1519b18ec9f5d9e5.js" },
      {
        revision: null,
        url: "/_next/static/chunks/app/_global-error/page-05440ab75205e227.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/app/_not-found/page-afd3fae1c50c1070.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/app/layout-7951c42066a20291.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/app/manifest.webmanifest/route-05440ab75205e227.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/app/page-03daeed0aff7b826.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/framework-6b85cd74e32b371b.js",
      },
      { revision: null, url: "/_next/static/chunks/main-0b7154afc6703974.js" },
      {
        revision: null,
        url: "/_next/static/chunks/main-app-c030c290cda8a718.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/next/dist/client/components/builtin/app-error-05440ab75205e227.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/next/dist/client/components/builtin/forbidden-05440ab75205e227.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/next/dist/client/components/builtin/global-error-30f17c4f020f43b0.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/next/dist/client/components/builtin/not-found-05440ab75205e227.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/next/dist/client/components/builtin/unauthorized-05440ab75205e227.js",
      },
      {
      ...
      {
        revision: null,
        url: "/_next/static/chunks/webpack-967d74252819ec76.js",
      },
      { revision: null, url: "/_next/static/css/481382b7d9acd857.css" },
      {
      ...
      },
      {
        ...
        url: "/_next/static/uKSumood1uSApOlqNgHIF/_buildManifest.js",
      },
      {
        revision: "b6652df95db52feb4daf4eca35380933",
        url: "/_next/static/uKSumood1uSApOlqNgHIF/_ssgManifest.js",
      },
